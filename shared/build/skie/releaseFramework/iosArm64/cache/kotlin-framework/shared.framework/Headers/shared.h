...
@class __SkieLambdaErrorType, SharedBase, SharedMutableSet<ObjectType>, SharedMutableDictionary<KeyType, ObjectType>, NSError, SharedNumber, SharedByte, SharedUByte, SharedShort, SharedUShort, SharedInt, SharedUInt, SharedLong, SharedULong, SharedFloat, SharedDouble, SharedBoolean, SharedSkieColdFlowIterator<E>, SharedSkieKotlinFlow<__covariant T>, SharedSkieKotlinMutableSharedFlow<T>, SharedSkieKotlinMutableStateFlow<T>, SharedSkieKotlinOptionalFlow<__covariant T>, SharedSkieKotlinOptionalMutableSharedFlow<T>, SharedSkieKotlinOptionalMutableStateFlow<T>, SharedSkieKotlinOptionalSharedFlow<__covariant T>, SharedSkieKotlinOptionalStateFlow<__covariant T>, SharedSkieKotlinSharedFlow<__covariant T>, SharedSkieKotlinStateFlow<__covariant T>, SharedSkie_CancellationHandler, SharedSkie_SuspendHandler, SharedSkie_SuspendResult, SharedSkie_SuspendResultCanceled, SharedSkie_SuspendResultError, SharedSkie_SuspendResultSuccess, SharedBaseViewModel, SharedPlatform, SharedArticlesInjector, SharedArticlesState, SharedArticlesViewModel, SharedArticle, SharedArticlesUseCase, SharedArticleRaw, SharedArticleRawCompanion, SharedArticlesDataSource, SharedArticlesRepository, SharedArticlesResponse, SharedArticlesResponseCompanion, SharedArticlesService, SharedDatabaseDriverFactory, SharedArticle_, SharedDriverClientAppDatabaseCompanion, SharedRuntimeBaseTransacterImpl, SharedRuntimeTransacterImpl, SharedDriverClientAppDatabaseQueries, Shared__SkieSuspendWrappersKt, SharedSkieTypeExportsKt, SharedDatabaseModuleKt, SharedNetworkModuleKt, SharedSharedKoinModulesKt, SharedKoinInitializerKt, SharedArticlesModuleKt, SharedKotlinThrowable, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinCancellationException, SharedKoin_coreKoin, SharedKtor_client_coreHttpClient, SharedKotlinUnit, SharedRuntimeTransacterTransaction, SharedRuntimeExecutableQuery<__covariant RowType>, SharedRuntimeQuery<__covariant RowType>, SharedKtor_httpOutgoingContent, SharedKtor_httpOutgoingContentProtocolUpgrade, SharedKtor_httpOutgoingContentWriteChannelContent, SharedKtor_client_coreHttpRequestData, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_ioMemory, SharedKtor_ioBuffer, SharedKtor_ioChunkBuffer, SharedKotlinByteArray, SharedKtor_ioInput, SharedKtor_ioByteReadPacket, SharedKtor_client_coreHttpClientCall, SharedKtor_utilsTypeInfo, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_corePolymorphicKind, SharedKotlinx_serialization_corePrimitiveKind, SharedKotlinx_serialization_coreSerialKindCONTEXTUAL, SharedKotlinx_serialization_coreSerialKindENUM, SharedKotlinx_serialization_coreStructureKind, SharedKotlinx_serialization_corePolymorphicKindOPEN, SharedKotlinx_serialization_corePolymorphicKindSEALED, SharedKotlinx_serialization_corePrimitiveKindBOOLEAN, SharedKotlinx_serialization_corePrimitiveKindBYTE, SharedKotlinx_serialization_corePrimitiveKindCHAR, SharedKotlinx_serialization_corePrimitiveKindDOUBLE, SharedKotlinx_serialization_corePrimitiveKindFLOAT, SharedKotlinx_serialization_corePrimitiveKindINT, SharedKotlinx_serialization_corePrimitiveKindLONG, SharedKotlinx_serialization_corePrimitiveKindSHORT, SharedKotlinx_serialization_corePrimitiveKindSTRING, SharedKotlinx_serialization_coreStructureKindCLASS, SharedKotlinx_serialization_coreStructureKindLIST, SharedKotlinx_serialization_coreStructureKindMAP, SharedKotlinx_serialization_coreStructureKindOBJECT, SharedKtor_httpOutgoingContentByteArrayContent, SharedKtor_httpOutgoingContentNoContent, SharedKtor_httpOutgoingContentReadChannelContent, SharedKoin_coreModule, SharedKotlinArray<T>, SharedKoin_coreLockable, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinEnum<E>, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreLogger, SharedKoin_coreExtensionManager, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedRuntimeAfterVersion, SharedKtor_utilsAttributeKey<T>, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentType, SharedKtor_httpHttpStatusCode, SharedKtor_client_coreHttpResponseData, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_utilsPipelinePhase, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKotlinByteIterator, SharedKtor_ioInputCompanion, SharedKtor_ioByteReadPacketCompanion, SharedKtor_client_coreHttpClientCallCompanion, SharedKtor_client_coreHttpResponse, SharedKotlinLongProgression, SharedKotlinLongRange, SharedKoin_coreKoinDefinition<R>, SharedKoin_coreInstanceFactory<T>, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreScopeDSL, SharedKotlinEnumCompanion, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinNothing, SharedKtor_client_coreProxyConfig, SharedKtor_eventsEventDefinition<T>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpSendPipelinePhases, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpContentTypeCompanion, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKtor_httpUrlCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpHttpMethodCompanion, SharedKotlinKTypeProjection, SharedKotlinLongProgressionCompanion, SharedKotlinLongIterator, SharedKotlinLongRangeCompanion, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_httpURLProtocolCompanion, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpURLBuilderCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, NSString, NSArray, NSMutableArray, NSDictionary, NSSet;

@protocol SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreMutableSharedFlow, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_coroutines_coreMutableStateFlow, SharedSkie_DispatcherDelegate, SharedKoin_coreKoinComponent, SharedRuntimeTransacterBase, SharedRuntimeTransacter, SharedDriverClientAppDatabase, SharedKotlinx_coroutines_coreRunnable, SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreKSerializer, SharedKtor_ioCloseable, SharedRuntimeCloseable, SharedRuntimeSqlDriver, SharedRuntimeTransactionCallbacks, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeSqlSchema, SharedRuntimeSuspendingTransacter, SharedKotlinFunction, SharedKotlinSuspendFunction1, SharedKtor_ioByteReadChannel, SharedKtor_ioByteWriteChannel, SharedKotlinCoroutineContext, SharedKtor_client_coreHttpClientEngine, SharedRuntimeQueryResult, SharedKotlinAppendable, SharedKotlinCoroutineContextElement, SharedKotlinx_coroutines_coreJob, SharedKotlinSuspendFunction2, SharedKotlinx_coroutines_coreSelectClause, SharedKotlinx_coroutines_coreSelectClause1, SharedKotlinx_coroutines_coreSelectClause2, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinKClass, SharedKotlinLazy, SharedKotlinComparable, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreDecoder, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_utilsAttributes, SharedRuntimeQueryListener, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedKtor_utilsStringValues, SharedKtor_httpHeaders, SharedKtor_ioReadSession, SharedKotlinCoroutineContextKey, SharedKotlinContinuationInterceptor, SharedKtor_ioObjectPool, SharedKotlinIterator, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_httpHttpMessage, SharedKtor_client_coreHttpRequest, SharedKotlinKType, SharedKotlinIterable, SharedKotlinClosedRange, SharedKotlinOpenEndRange, SharedKotlinx_coroutines_coreSelectInstance, SharedKoin_coreScopeCallback, SharedKoin_coreKoinExtension, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKtor_client_coreHttpClientPlugin, SharedKtor_httpHttpMessageBuilder, SharedKotlinMapEntry, SharedKotlinContinuation, SharedKtor_httpParameters, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder;
...
- (instancetype)initWithDatabase:(id<SharedDriverClientAppDatabase>)database __attribute__((swift_name("init(database:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("DriverClientAppDatabase")))
@protocol SharedDriverClientAppDatabase <SharedRuntimeTransacter>
@required
@property (readonly) SharedDriverClientAppDatabaseQueries *driverClientAppDatabaseQueries __attribute__((swift_name("driverClientAppDatabaseQueries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DriverClientAppDatabaseCompanion")))
@interface SharedDriverClientAppDatabaseCompanion : SharedBase
@property (class, readonly, getter=shared) SharedDriverClientAppDatabaseCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) id<SharedRuntimeSqlSchema> Schema __attribute__((swift_name("Schema")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedDriverClientAppDatabase>)invokeDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("invoke(driver:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DriverClientAppDatabaseQueries")))
@interface SharedDriverClientAppDatabaseQueries : SharedRuntimeTransacterImpl
- (instancetype)initWithDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("init(driver:)"))) __attribute__((objc_designated_initializer));
...
+ (void)Skie_Suspend__3__getArticlesDispatchReceiver:(SharedArticlesUseCase *)dispatchReceiver forceFetch:(BOOL)forceFetch suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__getArticles(dispatchReceiver:forceFetch:suspendHandler:)")));
+ (void)Skie_Suspend__4__getArticlesDispatchReceiver:(SharedArticlesRepository *)dispatchReceiver forceFetch:(BOOL)forceFetch suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__4__getArticles(dispatchReceiver:forceFetch:suspendHandler:)")));
...
+ (void)Skie_Suspend__6__transactionDispatchReceiver:(id<SharedRuntimeSuspendingTransacter>)dispatchReceiver noEnclosing:(BOOL)noEnclosing body:(id<SharedKotlinSuspendFunction1>)body suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__transaction(dispatchReceiver:noEnclosing:body:suspendHandler:)")));
+ (void)Skie_Suspend__7__transactionWithResultDispatchReceiver:(id<SharedRuntimeSuspendingTransacter>)dispatchReceiver noEnclosing:(BOOL)noEnclosing bodyWithReturn:(id<SharedKotlinSuspendFunction1>)bodyWithReturn suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__7__transactionWithResult(dispatchReceiver:noEnclosing:bodyWithReturn:suspendHandler:)")));
+ (void)Skie_Suspend__8__upgradeDispatchReceiver:(SharedKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<SharedKtor_ioByteReadChannel>)input output:(id<SharedKtor_ioByteWriteChannel>)output engineContext:(id<SharedKotlinCoroutineContext>)engineContext userContext:(id<SharedKotlinCoroutineContext>)userContext suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__8__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__9__writeToDispatchReceiver:(SharedKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<SharedKtor_ioByteWriteChannel>)channel suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__9__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__10__executeDispatchReceiver:(id<SharedKtor_client_coreHttpClientEngine>)dispatchReceiver data:(SharedKtor_client_coreHttpRequestData *)data suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__10__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__11__executeDispatchReceiver:(SharedKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__11__execute(dispatchReceiver:context:subject:suspendHandler:)")));
+ (void)Skie_Suspend__12__awaitDispatchReceiver:(id<SharedRuntimeQueryResult>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__12__await(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__13__invokeDispatchReceiver:(id<SharedKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__13__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__14__awaitContentDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__14__awaitContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__15__discardDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver max:(int64_t)max suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__15__discard(dispatchReceiver:max:suspendHandler:)")));
+ (void)Skie_Suspend__16__peekToDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver destination:(SharedKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__16__peekTo(dispatchReceiver:destination:destinationOffset:offset:min:max:suspendHandler:)")));
+ (void)Skie_Suspend__17__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKtor_ioChunkBuffer *)dst suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__17__readAvailable(dispatchReceiver:dst:suspendHandler:)")));
+ (void)Skie_Suspend__18__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__18__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__19__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__19__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__20__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__20__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__21__readBooleanDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__21__readBoolean(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__22__readByteDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__22__readByte(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__23__readDoubleDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__23__readDouble(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__24__readFloatDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__24__readFloat(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__25__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKtor_ioChunkBuffer *)dst n:(int32_t)n suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__25__readFully(dispatchReceiver:dst:n:suspendHandler:)")));
+ (void)Skie_Suspend__26__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__26__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__27__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__27__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__28__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__28__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__29__readIntDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__29__readInt(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__30__readLongDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__30__readLong(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__31__readPacketDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver size:(int32_t)size suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__31__readPacket(dispatchReceiver:size:suspendHandler:)")));
+ (void)Skie_Suspend__32__readRemainingDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver limit:(int64_t)limit suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__32__readRemaining(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__33__readShortDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__33__readShort(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__34__readSuspendableSessionDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver consumer:(id<SharedKotlinSuspendFunction1>)consumer suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__34__readSuspendableSession(dispatchReceiver:consumer:suspendHandler:)")));
+ (void)Skie_Suspend__35__readUTF8LineDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver limit:(int32_t)limit suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__35__readUTF8Line(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__36__readUTF8LineToDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver out:(id<SharedKotlinAppendable>)out limit:(int32_t)limit suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__36__readUTF8LineTo(dispatchReceiver:out:limit:suspendHandler:)")));
+ (void)Skie_Suspend__37__awaitFreeSpaceDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__37__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__38__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKtor_ioChunkBuffer *)src suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__38__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__39__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__39__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__40__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__40__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__41__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__41__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__42__writeByteDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__43__writeDoubleDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__44__writeFloatDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__45__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver memory:(SharedKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__46__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKtor_ioBuffer *)src suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__writeFully(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__47__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
...
+ (void)Skie_Suspend__49__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__50__writeIntDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__51__writeLongDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__52__writePacketDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver packet:(SharedKtor_ioByteReadPacket *)packet suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__53__writeShortDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__54__writeSuspendSessionDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<SharedKotlinSuspendFunction1>)visitor suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__55__joinDispatchReceiver:(id<SharedKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__56__invokeDispatchReceiver:(id<SharedKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__57__bodyDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(SharedKtor_utilsTypeInfo *)info suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__body(dispatchReceiver:info:suspendHandler:)")));
+ (void)Skie_Suspend__58__bodyNullableDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(SharedKtor_utilsTypeInfo *)info suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__bodyNullable(dispatchReceiver:info:suspendHandler:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
+ (void)Skie_Suspend__59__getResponseContentDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__getResponseContent(dispatchReceiver:suspendHandler:)")));
@end

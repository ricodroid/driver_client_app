...
@NonNullApi
public class DriverClientAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public DriverClientAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
